...
Color backGroundMainColor = Color(0xff020100);
Color panelColor = Color(0xff191923);
Color casesColor = Color(0xFFF5BB00);
Color activeColor =  Color(0xFFEC9F05);
Color recoveredColor = Color(0xFF8EA604);
Color criticalColor =Color(0xFFD84A05);
Color deathsColor =Color(0xFFE70E02);
